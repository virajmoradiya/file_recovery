package photo.video.recovery.ui.dashboard
...
import photo.video.recovery.databinding.DialogPermissionPermanetlyBinding
import photo.video.recovery.extension.addBounceAnim
import photo.video.recovery.extension.getCompactDrawable
import photo.video.recovery.extension.hasPermissions
import photo.video.recovery.extension.startActivity
import photo.video.recovery.extension.toast
import photo.video.recovery.ui.recovered_media.activity.RecoveredFileActivity
import photo.video.recovery.ui.scanImage.activity.ImageScanActivity
